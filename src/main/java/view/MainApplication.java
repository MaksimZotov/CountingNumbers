...
public class MainApplication extends Application implements ApplicationObligations {
    private ClientObligations client;
    private Stage stage;
    ...
    @Override
    public void getEventPlayerLost(String data) {
